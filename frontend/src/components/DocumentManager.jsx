...
export default function DocumentManager({
  ...
  const handleDelete = async (document) => {
    ...
    if (
      !window.confirm(
        `Are you sure you want to delete "${document.original_filename || document.filename}"?`,
      )
    ) {
      return;
    }
  ...
  const filteredAndSortedDocuments = documents
    .filter((doc) => {
      ...
      const matchesStatus =
        ...
        (doc.processing_status ||
          (doc.processed ? "indexed" : "processing")) === statusFilter;
    ...
    .sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case "status":
          aValue =
            a.processing_status || (a.processed ? "indexed" : "processing");
          bValue =
            b.processing_status || (b.processed ? "indexed" : "processing");
          break;
        case "created_at":
        default:
  ...
  const getStatusCounts = () => {
    ...
    documents.forEach((doc) => {
      const status =
        doc.processing_status || (doc.processed ? "indexed" : "processing");
  ...
  return (
    <div
      className="flex h-full w-full p-10 flex-col border bg-card text-input"
      style={fontStyle}
    >
      {/* Header */}
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <select
                  ...
                  className="border border-input rounded-md bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent"
                >
